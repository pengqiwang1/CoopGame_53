...
UCLASS()
class COOPGAME_427_API AWeaponBaseClient : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY(EditAnywhere)
	int FPArmsBlendPoseIndex;

	UPROPERTY(EditAnywhere)
	float FieldOfAimimgView;
...
public:	
	...
	void DisplayClientWeaponSound();

	void DisplayClientWeaponEffect();
